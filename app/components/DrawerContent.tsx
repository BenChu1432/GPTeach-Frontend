...
import { Image, Platform, SafeAreaView, StatusBar, StyleSheet, Text, View, TouchableOpacity, Linking } from "react-native";
...
export default function DrawerContent(props: Props) {
    ...
    return (
        <Screen>
            ...
            <TouchableOpacity style={styles.drawerItemContainer} onPress={() => navigation.navigate("Subscription")}>
                <View style={styles.drawerItem}>
