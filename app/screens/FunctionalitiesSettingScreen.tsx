    ...
    return(
        <ScrollView style={styles.container}>
            {currentCategory!=="Language Enrichment"?
                <>
                    <Text style={styles.theme}>{currentCategory==="Literary Devices"?"Theme/Literature":"Theme"}</Text>
                    <View style={styles.themeContainer}>
                        <View style={styles.themeInputContainer}>
                            <TextInput defaultValue={selectedTheme} onChangeText={setSelectedTheme} style={styles.themeInput}/>
                        </View>
                    </View>
                </> :null}
