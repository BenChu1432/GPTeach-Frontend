            ...
            <ScrollView style={styles.scrollView}>
                <View style={styles.subContainer}>
                    ...
                    <ThemeCard
                        ...
                        colors={"#ffdd5a"}
                        position={-40}
                        navigate={"SentenceStructure"}
                    />
                    <ThemeCard name={"Language Enrichment"} Ionicons={"language"} size={160} colors={"#64BCFB"} position={-40} navigate={"ThemeBasedVsCustomized"} />
                    <ThemeCard name={"Register"} Ionicons={"layers"} size={120} colors={"#26de81"} position={-20} navigate={"Library"} />
